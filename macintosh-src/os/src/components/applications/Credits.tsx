...
const CREDITS = [
    {
        ...
        rows: [
            ...
            ['3D Site', 'github.com/henryjeff/portfolio-website'],
            ['OS Site', 'github.com/henryjeff/portfolio-inner-site'],
            ['Adapted by Tongyun Yang', "with Henry's permission"],
        ],
    },
    {
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2>Credits</h2>
                <p>my macintosh, 2026 — built on henryheffernan.com, 2022</p>
                <br />
                <br />
                <br />
