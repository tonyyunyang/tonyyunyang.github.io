...
import research from '../../assets/pictures/projects/art.gif';
import life from '../../assets/pictures/projects/music.gif';
    ...
    return (
        <div className="site-page-content">
            ...
            <p>
                ...
                favorite work in that field. Software is what I build, Research
                is what I publish, and Life is everything that keeps the other
                two running. Enjoy!
            </p>
            <br />
